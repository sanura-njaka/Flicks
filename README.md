...
<img src='walkthrough_rotation.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes
It was difficult to make sure the interface stayed looking nice while trying to add all of the implementations. It was also challenging to add the extenstions because some thing required extra research to figure out.
